    ...
    return isloading ? <p>Loading... </p> : (
        ...
        <div className="h-full w-full py-4 rounded-xl bg-white px-4">
          <div>
            ...
            <h2 className="text-2xl font-medium text-[#6f6d6d]">
              {data.detail}
            </h2>
            ...
            <div className='lg:w-1/3 '><h2 className=' text-justify break-word pt-8 text-sm font-medium lg:hidden'>{data.description_category}</h2>
            </div>
            </div>
        ...
        <div className='border-b w-[80%] mx-auto'>
        <Footer />
        </div>
      </main>
    );
