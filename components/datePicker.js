...
function DateRangePicker() {
  ...
  return (
    ...
    <div className="w-full text-white bg-black flex-col pt-4 pb-4 px-8 py-18 mt-5 mr-5 ml-5 rounded-md md:flex flex-row max-w-screen items-center min-w-screen justify-between">
